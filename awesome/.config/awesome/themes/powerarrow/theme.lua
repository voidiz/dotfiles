...
function theme.at_screen_connect(s)
    ...
    s.mywibox:setup {
        ...
        { -- Right widgets
            ...
            arrow("#8DAA9A", "#AAAA8F"),
            wibox.container.background(wibox.container.margin(wibox.widget { nil, neticon, net.widget, layout = wibox.layout.align.horizontal }, 3, 3), "#AAAA8F"),
            arrow("#AAAA8F", "#777E76"),
            wibox.container.background(wibox.container.margin(mytextclock, 4, 3), "#777E76"),
            arrow("#777E76", "alpha"),
            --]]
            s.mylayoutbox,
        },
