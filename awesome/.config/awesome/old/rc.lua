...
awful.screen.connect_for_each_screen(function(s)
    ...
    -- Create a separator
    separator = wibox.container.margin(_, 5, 5)
...
globalkeys = gears.table.join(
    ...
    awful.key({}, "XF86MonBrightnessDown", function() brightness_widget.dec() end,
              {description = "decrease the screen brightness", group = "brightness"}),
    awful.key({}, "XF86MonBrightnessUp", function() brightness_widget.inc() end,
              {description = "increase the screen brightness", group = "brightness"}),
    ...
    awful.key({}, "XF86AudioMute", function() volume_widget.mute() end,
              {description = "mute the volume", group = "volume"})
)
