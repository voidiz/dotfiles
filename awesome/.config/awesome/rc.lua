...
local scrlocker    = "$HOME/.xlock/lock.sh"
...
globalkeys = my_table.join(
    ...
    awful.key({ modkey          }, "d", function () os.execute(string.format("rofi -show drun")) end,
              {description = "show drun", group = "launcher"}),

    awful.key({ modkey, "Shift" }, "d", function () os.execute(string.format("rofi -show run")) end,
              {description = "run prompt", group = "launcher"}),
