...
`dotspacemacs/user-config' first."
  (setq theming-modifications '(
        (dracula
          (default :background "#071523")
          (fringe :background "#071523")
          (linum :background "#071523")
          (powerline-active1 :background "#071523")
          (powerline-active2 :background "#071523")
        )
      )
    )
  )
